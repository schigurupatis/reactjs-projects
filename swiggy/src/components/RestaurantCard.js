...
<div className="res-card card  rounded-2xl w-[226px] h-72">
  ...
  <div className="res-data px-4 py-3">
      ...
      <div className="flex justify-between items-center">
          <h4 className="ratings font-semibold text-slate-900">{avgRatingString} Stars</h4>
          <h4 className="delivery-time font-medium text-slate-900">{sla.deliveryTime} Mins</h4>
      </div>
