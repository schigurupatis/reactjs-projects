                    ...
                    <div className="card-shadow">
                        <div className="card">
                            ...
                            <div className="msg-box">
                                <img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_40,h_40/v1648635511/Delivery_fee_new_cjxumu" alt="DISTANCE_FEE_NON_FOOD_LM" aria-hidden="true" class="sc-fKWMtX gJQjbk" />
